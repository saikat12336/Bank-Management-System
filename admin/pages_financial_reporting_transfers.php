...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>iBanking Advanced Reporting : Transfers</h1>
            </div>
            <div class="col-sm-6">
  ...
  <thead>
    <tr>
      ...
      <th>Receiver</th>
      <th>Timestamp</th>
      <th>Initiated By</th> <!-- New Column -->
    </tr>
  </thead>
  <tbody>
    <?php
    // Get latest transfer transactions 
    $ret = "SELECT * FROM iB_Transactions WHERE tr_type = 'Transfer' ORDER BY created_at DESC";
...
<?php
          if (!empty($row->staff_name)) {
            echo "<span class='badge badge-primary'>Staff: $row->staff_name</span>";
          } elseif (!empty($row->admin_id)) {
            echo "<span class='badge badge-dark'>Administrator</span>";
          } else {
            echo "<span class='badge badge-success'>Client</span>";
          }
          ?>
</td>
      </tr>
