...
<tbody>
  <?php
  //fetch all approved iB_Accs
  $ret = "SELECT * FROM iB_bankAccounts WHERE acc_status = 'Approved'";
  ...
  ?>
    <tr>
      <td colspan="7" class="text-center text-danger font-weight-bold">
       Currently, there are no bank accounts approved for diposite operations.
      </td>
    </tr>
  <?php } ?>
</tbody>
