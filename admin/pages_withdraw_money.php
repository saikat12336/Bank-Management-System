...
if (isset($_POST['withdrawal'])) {
    ...
    $notification_details = "$client_name Has Withdrawn Rs. $transaction_amt From Bank Account $account_number Handled by Admin";
    ...
    if ($transaction_amt > $amt) {
        ...
        // Insert transaction
        $query = "INSERT INTO iB_Transactions (tr_code, account_id, acc_name, account_number, acc_type, tr_type, tr_status, client_id, client_name, client_national_id, transaction_amt, client_phone, admin_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        $admin_msg = "$client_name has withdrawn Rs. $transaction_amt from Bank Account $account_number Handled by Admin.";
