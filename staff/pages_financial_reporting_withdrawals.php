...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
  ...
  <tbody>
    ...
    $ret = "SELECT * FROM iB_Transactions WHERE tr_type = 'Withdrawal' ORDER BY created_at DESC";
      ...
      <tr>
        ...
        <td>
          ...
          if (!empty($row->staff_name)) {
            echo "<span class='badge badge-info'>$row->staff_name</span>";
          } else {
            echo "<span class='badge badge-secondary'>Administrator</span>";
          }
          ?>
        </td>
      </tr>
