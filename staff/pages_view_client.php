...
if (isset($_POST['change_client_password'])) {
    ...
    $stmt = $mysqli->prepare("SELECT password FROM iB_clients WHERE client_number = ?");
    ...
    $err = "New Password cannot be the same as Old Password!";
        ...
        $stmt->bind_param('ss', $hashed_new_password, $client_number);
        if ($stmt->execute()) {
...
<form method="post" class="form-horizontal">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="password" name="password" class="form-control" required id="new_password">
        </div>
    </div>
    <div class="form-group row">
