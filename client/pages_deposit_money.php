...
if (isset($_POST['deposit'])) {
    ...
    $notification = "INSERT INTO iB_notifications (notification_for, client_id, notification_details) VALUES (?, ?, ?)";
    ...
    $notification_for_admin = "admin";
    $notification_stmt->bind_param('sis', $notification_for_admin, $client_id, $notification_details);
    $notification_stmt->execute();

    // Send notification to Staff
    $notification_for_staff = "staff";
    $notification_stmt->bind_param('sis', $notification_for_staff, $client_id, $notification_details);
    $notification_stmt->execute();

        // Notification for Client
    $notification_for_client = "client";
    $client_notification = "The amount Rs. $transaction_amt has been credited to your iBank Account $account_number. Thank you for banking with us!";
    $notification_stmt->bind_param('sis', $notification_for_client, $client_id, $client_notification);
    $notification_stmt->execute();
